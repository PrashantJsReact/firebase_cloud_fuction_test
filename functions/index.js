...
exports.getSubscriptionStatus1 = exports.getSubscriptionStatus = exports.createPaymentLink1 = void 0;
...
exports.createPaymentLink = functions.https.onCall((data, context) => {
...
exports.getSubscriptionStatus = functions.https.onRequest((request, response) => {
  request = {
    "data": {
      "cf_link_id": 1576977,
